...
const QuotationSchema = new mongoose.Schema(
    {
        authorFirstName: {
            ...
            minlength: [
                2,
                "Author's first name must be at least two characters long.",
            ],
            maxlength: [
                30,
                "Author's first name must not be longer than 30 characters.",
            ],
        },
        authorLastName: {
            type: String,
            ...
            minlength: [
                2,
                "Author's last name must be at least two characters long.",
            ],
            maxlength: [
                30,
                "Author's last name must not be longer than 30 characters.",
            ],
        },
        bookTitle: {
            type: String,
            ...
            maxlength: [
                50,
                'Book title must not be longer than 50 characters.',
            ],
        },
        publisherName: {
            type: String,
            ...
            minlength: [
                2,
                'Publisher name must be at least two characters long.',
            ],
            maxlength: [
                30,
                'Publisher name must not be longer than 30 characters.',
            ],
        },
        publisherLocation: {
            type: String,
            ...
            minlength: [
                2,
                'Publisher location must be at least two characters long.',
            ],
            maxlength: [
                30,
                'Publisher location must not be longer than 30 characters.',
            ],
        },
        yearPublished: {
            type: Number,
        ...
        quotation: {
            ...
            maxlength: [
                2000,
                'Quotation must not be longer than 2,000 characters.',
            ],
        },
        comments: {
            type: String,
            maxlength: [
                2000,
                'Comments must not be longer than 2,000 characters.',
            ],
        },
        userId: {
            type: String,
